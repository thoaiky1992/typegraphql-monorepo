...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "email", "userName", "password", "_count", "_avg", "_sum", "_min", "_max"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "email", "userName", "password"],
  UserOrderByWithRelationInput: ["id", "email", "userName", "password"],
  UserWhereUniqueInput: ["id", "email", "AND", "OR", "NOT", "userName", "password"],
  UserOrderByWithAggregationInput: ["id", "email", "userName", "password", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "userName", "password"],
  UserCreateInput: ["email", "userName", "password"],
  UserUpdateInput: ["email", "userName", "password"],
  UserCreateManyInput: ["id", "email", "userName", "password"],
  UserUpdateManyMutationInput: ["email", "userName", "password"],
